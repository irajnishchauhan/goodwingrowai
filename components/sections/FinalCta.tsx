    ...
    <section className="py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
        ...
        >
          ...
          <span className="text-glow text-accent">Start building a growth engine.</span>
        </motion.h2>
        ...
        >
          Goodwin Grow AI combines strategy, creativity, performance and automation into one intelligent system.
        </motion.p>
        ...
        >
          ...
          <a href="#contact">
            <GlowButton variant="outline" className="w-full sm:w-auto h-14 px-10 text-base">
